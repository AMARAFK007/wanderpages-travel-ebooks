...
const Index = () => {
  ...
  return (
    <main>
      ...
      <section className="container mx-auto grid md:grid-cols-2 gap-8 py-12 items-center">
        <div className="space-y-6">
          <h1 className="text-4xl md:text-5xl font-bold leading-tight">Explore Smarter with WanderPages</h1>
        ...
        <div className="grid grid-cols-3 md:grid-cols-3 gap-3">
          <img src={santorini} alt="Santorini sunset travel hero image" className="rounded-md object-cover h-40 md:h-56 w-full" loading="lazy" />
          <img src={japan} alt="Tokyo neon street at night travel hero image" className="rounded-md object-cover h-40 md:h-56 w-full" loading="lazy" />
          <img src={maldives} alt="Maldives tropical aerial travel hero image" className="rounded-md object-cover h-40 md:h-56 w-full" loading="lazy" />
        </div>
      </section>
